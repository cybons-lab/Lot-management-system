...
Defined in: [src/components/ui/button.tsx:33](https://github.com/cybons-lab/Lot-management-system/blob/27136a70bad131ce7a63fc3b65b7329cb546f591/frontend/src/components/ui/button.tsx#L33)
...
Defined in: [src/components/ui/button.tsx:19](https://github.com/cybons-lab/Lot-management-system/blob/27136a70bad131ce7a63fc3b65b7329cb546f591/frontend/src/components/ui/button.tsx#L19)
...
> `optional` **variant**: `"link"` \| `"default"` \| `"destructive"` \| `"outline"` \| `"secondary"` \| `"ghost"` \| `null`

Defined in: [src/components/ui/button.tsx:11](https://github.com/cybons-lab/Lot-management-system/blob/27136a70bad131ce7a63fc3b65b7329cb546f591/frontend/src/components/ui/button.tsx#L11)
