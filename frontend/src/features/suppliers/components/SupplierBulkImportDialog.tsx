  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>仕入先一括インポート</DialogTitle>
          <DialogDescription>CSVファイルで仕入先を一括登録・更新・削除できます</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border-2 border-dashed p-4 text-center">
            <input type="file" accept=".csv" onChange={handleFileChange} className="hidden" id="supplier-csv-input" />
            <label htmlFor="supplier-csv-input" className="cursor-pointer">
